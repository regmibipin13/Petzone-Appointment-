                                ...
                                <div class="card-body">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="type" name="type">
                                                        ...
                                                        <option value="doctor" <?php if ($type == 'doctor') echo 'selected'; ?>>Doctor
                                                        </option>
                                                        <option value="customer" <?php if ($type == 'customer') echo 'selected'; ?>>Customer
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <nav aria-label="Pagination">
                                        <ul class="pagination justify-content-center">
                                            <?php if ($page > 1) : ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="?page=<?php echo $page - 1; ?>&name=<?php echo $name; ?>&email=<?php echo $email; ?>&type=<?php echo $type; ?>" aria-label="Previous">
                                            ...
                                            <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                                                <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
                                                    <a class="page-link" href="?page=<?php echo $i; ?>&name=<?php echo $name; ?>&email=<?php echo $email; ?>&type=<?php echo $type; ?>">
                                                        <?php echo $i; ?>
                                                    </a>
                                                </li>
                                            <?php endfor; ?>
                                            ...
                                            <?php if ($page < $totalPages) : ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="?page=<?php echo $page + 1; ?>&name=<?php echo $name; ?>&email=<?php echo $email; ?>&type=<?php echo $type; ?>" aria-label="Next">

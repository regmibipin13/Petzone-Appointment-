                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="appointment_id" name="appointment_id" value="<?php echo $appointmentId; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="appointment_date">Appointment Date</label>
                                                    <input type="date" class="form-control" id="appointment_date" name="appointment_date" value="<?php echo $appointmentDate; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="cancel.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">Cancel</a>
